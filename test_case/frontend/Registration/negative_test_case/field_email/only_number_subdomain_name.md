...
### Сообщение об ошибке при вводе в поле "Ваш e-mail", емейлома с поддоменным именем из цифрд
...
2. Ввести в поле "Ваш e-mail" - "j@44.hf" (вводить без кавычек "")
...
|     ---     |  ---  |    ---      |   ---  |      ---      |
|  12.12.2023 | 22:18 |   failed    | @Baidak_Evgenii | https://gitlab.com/DJWOMS/front/-/issues/15 |