...
### Сообщение об ошибке при вводе в поле "Ваш e-mail", емейла с пробелом внутри самого емейла
...
2. Ввести в поле "Ваш e-mail" - "gequif furiz@yopmail.com" (вводить без кавычек "")
