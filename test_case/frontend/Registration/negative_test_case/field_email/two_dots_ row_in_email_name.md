...
### Сообщение об ошибке при вводе в поле "Ваш e-mail", емейл с двумя точками подряд, в имени емейла
...
2. Ввести в поле "Ваш e-mail" - "jfnhf..gkmjl@lf.hf" (вводить без кавычек "")
