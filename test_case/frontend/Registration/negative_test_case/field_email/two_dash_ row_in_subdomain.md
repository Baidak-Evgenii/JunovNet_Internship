...
### Сообщение об ошибке при вводе в поле "Ваш e-mail", в емейле два тире подряд, в поддоменной части
...
2. Ввести в поле "Ваш e-mail" - "test@9--m.com" (вводить без кавычек "")
...
|     ---     |  ---  |    ---      |   ---  |      ---      |
|  13.12.2023 | 22:50 |   failed    | @Baidak_Evgenii | https://gitlab.com/DJWOMS/front/-/issues/33 |