...
#Успешное обновление персональных данных ментора, при заполнении всех полей валидными данными и оставлении поля "site" пустым
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-13 | 20:21 |   passed    | Евгений|ссылка на баг|