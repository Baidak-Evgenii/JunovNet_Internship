...
#Сообщение об ошибке при отправке запроса с дробным числом с запятой в поле "mentor_experience"
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 18:03 |   passed    | Евгений|ссылка на баг|