...
#Сообщение об ошибке при отправке запроса с заполненым типом данных объект, полем "mentor_experience"
...
- Body запроса: 
{
  ...
  "dev_experience": 66,
  "mentor_experience": { "name":"John", "age":30, "car":null }
}
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 18:02 |   passed    | Евгений|ссылка на баг|