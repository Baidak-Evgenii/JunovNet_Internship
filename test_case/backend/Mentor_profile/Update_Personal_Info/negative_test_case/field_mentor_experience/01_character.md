...
#Сообщение об ошибке при отправке запроса с заполненым цифрами в формате 01 полем "mentor_experience"
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 17:58 |   passed    | Евгений|ссылка на баг|