...
#Сообщение об ошибке при отправке запроса с заполненым типом данных массив полем "mentor_experience"
...
- Body запроса: 
{
  ...
  "dev_experience": 66,
  "mentor_experience": [ "Ford", "BMW", "Fiat" ]
}
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 17:59 |   passed    | Евгений|ссылка на баг|