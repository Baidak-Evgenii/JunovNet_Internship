...
#Сообщение об ошибке при отправке запроса с заполненым типом данных массив полем "position"
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 17:33 |   passed    | Евгений|ссылка на баг|