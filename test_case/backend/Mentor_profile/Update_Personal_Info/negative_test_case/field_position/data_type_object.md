...
#Сообщение об ошибке при отправке запроса с заполненым типом данных объект, полем "position"
...
- Body запроса: 
{
  ...
  "position": { "name":"John", "age":30, "car":null },
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 17:37 |   passed    | Евгений|ссылка на баг|