...
#Сообщение об ошибке при отправке запроса с заполненым типом данных массив полем "dev_experience"
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 17:50 |   passed    | Евгений|ссылка на баг|