...
#Сообщение об ошибке при отправке запроса с заполненым типом данных объект, полем "dev_experience"
...
- Body запроса: 
{
  ...
  "dev_experience": { "name":"John", "age":30, "car":null },
  "mentor_experience": 5
}
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 17:53 |   passed    | Евгений|ссылка на баг|