...
#Сообщение об ошибке при отправке запроса с заполненым HTML иньекцией полем "site"
...
- Body запроса: 
{
  ...
  "site": "<img src= "https://avatarko.ru/img/kartinka/2/zhivotnye_kot_prikol_ochki_1637.jpg">",
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 16:07 |   passed    | Евгений|ссылка на баг|