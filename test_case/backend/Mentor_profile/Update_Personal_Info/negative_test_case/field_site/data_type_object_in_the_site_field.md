...
#Сообщение об ошибке при отправке запроса с заполненым типом данных объект, полем "site"
...
- Body запроса: 
{
  ...
  "site": { "name":"John", "age":30, "car":null },
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 16:08 |   passed    | Евгений|ссылка на баг|