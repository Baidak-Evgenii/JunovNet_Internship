...
#Сообщение об ошибке при отправке запроса с заполненым HTML иньекцией полем "avatar"
...
- Body запроса:
{
  "avatar": "<img src= "https://avatarko.ru/img/kartinka/2/zhivotnye_kot_prikol_ochki_1637.jpg">",
  "first_name": "Иван",
  "last_name": "Петров"
}
