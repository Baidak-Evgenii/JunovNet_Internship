...
#Ошибка при обновлении данных профиля ментора, если поле avatar заполнено избражением формата png с размером 149x149 пикселе
...
- Body запроса: 
{
  "avatar": "https://dummyimage.com/149x149/000/fff.png",
  "first_name": "Иван",
  "last_name": "Петров"
}
