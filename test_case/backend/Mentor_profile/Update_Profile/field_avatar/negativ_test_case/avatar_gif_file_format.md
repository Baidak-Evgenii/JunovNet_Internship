...
#Ошибка при обновлении данных профиля ментора, если поле avatar заполнено избражением формата gif с размером 150x150 пикселе
...
- Body запроса: 
{
  "avatar": "https://dummyimage.com/150x150/000/fff.gif",
  "first_name": "Иван",
  "last_name": "Петров"
}
