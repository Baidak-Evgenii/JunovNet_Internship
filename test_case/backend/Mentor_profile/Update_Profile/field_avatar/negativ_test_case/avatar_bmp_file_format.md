...
#Ошибка при обновлении данных профиля ментора, если поле avatar заполнено избражением формата bmp
...
- Body запроса: 
{
  "avatar": "https://drive.google.com/file/d/1viNDIzB_-4a6ei2arDXgHSLx0K845Kvo/view?usp=sharing",
  "first_name": "Иван",
  "last_name": "Петров"
}
