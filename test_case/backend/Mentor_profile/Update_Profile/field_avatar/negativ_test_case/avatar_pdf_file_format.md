...
#Ошибка при обновлении данных профиля ментора, если поле avatar заполнено файлом в pdf формате
...
- Body запроса: 
{
  "avatar": "https://drive.google.com/file/d/1bV_C9C2BQEmXiLTb8k8qh8uMV0-JB6TX/view?usp=sharing",
  "first_name": "Иван",
  "last_name": "Петров"
}
