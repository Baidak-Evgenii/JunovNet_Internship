...
#Ошибка при обновлении данных профиля ментора, если поле avatar заполнено избражением формата jpeg с размером 150x149 пикселе
...
- Body запроса: 
{
  "avatar": "https://dummyimage.com/150x149/000/fff.jpeg",
  "first_name": "Иван",
  "last_name": "Петров"
}
