...
#Ошибка при обновлении данных профиля ментора, если поле avatar заполнено избражением формата jpeg с размером 150x150 пикселе и весом файла 1 гигабайт
...
- Body запроса: 
{
  "avatar": "https://drive.google.com/file/d/1H1Wgd5ww5z-GwZ9a3NrRWSvbHMpSWXNR/view?usp=drive_link",
  "first_name": "Иван",
  "last_name": "Петров"
}
