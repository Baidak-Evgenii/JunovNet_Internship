...
#Ошибка при обновлении данных профиля ментора, если поле avatar заполнено избражением формата png с размером 150x150 пикселей и весом файла 1,6 мегабайт
...
- Body запроса: 
{
  "avatar": "https://drive.google.com/file/d/10wypniGlaxK_wYx8p9quZQTSlj1Skn3n/view?usp=sharing",
  "first_name": "Иван",
  "last_name": "Петров"
}
