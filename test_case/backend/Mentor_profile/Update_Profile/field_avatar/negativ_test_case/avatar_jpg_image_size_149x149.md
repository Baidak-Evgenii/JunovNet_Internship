...
#Ошибка при обновлении данных профиля ментора, если поле avatar заполнено избражением формата jpg с размером 149x149 пикселе
...
- Body запроса: 
{
  "avatar": "https://dummyimage.com/149x149/000/fff.jpg",
  "first_name": "Иван",
  "last_name": "Петров"
}
