...
#Успешное обновление данных профиля ментора, при заполнении поля avatar избражением формата png с размером 150x150 пикселей
...
- Body запроса: 
{
  "avatar": "https://dummyimage.com/150x150/000/fff.png",
  "first_name": "Иван",
  "last_name": "Петров"
}
