...
#Успешное обновление данных профиля ментора, при заполнении поля avatar избражением формата png с размером 549x1321 пикселей
...
- Body запроса: 
{
  "avatar": "https://dummyimage.com/549x1321/000/fff.png",
  "first_name": "Иван",
  "last_name": "Петров"
}
