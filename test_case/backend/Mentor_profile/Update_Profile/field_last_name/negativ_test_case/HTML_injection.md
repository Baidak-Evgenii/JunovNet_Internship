...
#Сообщение об ошибке при отправке запроса с заполненым HTML иньекцией полем "last_name"
...
- Body запроса:
{
  ...
  "first_name": "Петров",
  "last_name": "<img src= "https://avatarko.ru/img/kartinka/2/zhivotnye_kot_prikol_ochki_1637.jpg">"
}
