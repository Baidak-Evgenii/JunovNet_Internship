...
#Сообщение об ошибке при отправке запроса с заполненым типом данных массив полем "first_name"
...
|     ---     |  ---  |    ---      |   ---  |      ---    |
|  2023-10-18 | 17:42 |   passed    | Евгений|ссылка на баг|