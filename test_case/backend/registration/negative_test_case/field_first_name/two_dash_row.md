...
### Сообщение об ошибке при отправке запроса с заполненым полем "first_name", со спецсимволами - два раза подряд
...
|     ---     |  ---  |    ---      |   ---  |      ---       |
|  08.12.2023 | 17:19 |   failed    | @Baidak_Evgenii | https://gitlab.com/DJWOMS/junov_net/-/issues/25 |
