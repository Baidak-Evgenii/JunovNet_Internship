...
### Сообщение об ошибке при отправке запроса с заполненым 21 символом полем "first_name"
...
```
{
  "first_name": "Екатерина-OBAMAЕкатер",
    ...
    "detail": [
        {
            ...
            "msg": "Value error, name must contain no more than 20 characters",
            "input": {
                "first_name": "Екатерина-OBAMAЕкатер",
                "email": "wecreussuveikeu-2230@yopmail.com",
                "password": "123q56!A",
