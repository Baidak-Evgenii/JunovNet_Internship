...
### Сообщение об ошибке при отправке запроса с заполнеными без спецсимволов полями "password" и "password_confirm"
    ...
    "detail": [
        {
            ...
            "msg": "Value error, This Password should contains at lease one special symbol and one digit",
            "input": {
                "first_name": "Екатерина-OBAMA",
                "email": "lesonroitri-5850@yopmail.com",
                "password": "1AmA4Jqdd",
