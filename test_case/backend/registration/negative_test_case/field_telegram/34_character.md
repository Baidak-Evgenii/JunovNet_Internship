...
### Сообщение об ошибке при отправке запроса с заполненым 34 символами, полем "telegram"
...
```
{
  ...
  "email": "wecreuveikeu-2230@yopmail.com",
  "password": "123q56!A",
  "telegram": "@HarHarHarHarHarHarHarHarHarHarHar",
    ...
    "detail": [
        {
            ...
            "msg": "Value error, telegram must contain no more than 32 characters and at least 5 characters",
            "input": {
                "first_name": "Екатерина-OBAMAЕ",
                "email": "wecreuveikeu-2230@yopmail.com",
                "password": "123q56!A",
