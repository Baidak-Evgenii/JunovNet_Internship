...
### Сообщение об ошибке при отправке запроса с заполненым полем "email", доменное имя заканчивается тире
    ...
    "detail": [
        {
            ...
            "msg": "value is not a valid email address: An email address cannot end with a hyphen.",
            "input": "test@9m.com-",
            "ctx": {
                "reason": "An email address cannot end with a hyphen."
            }
        }
    ]
}
