...
### Сообщение об ошибке при отправке запроса с заполненым полем "email", емейлом с доменным именем из цифр
    ...
    "detail": [
        {
            ...
            "input": "j@lh.44",
            "ctx": {
                "reason": "The part after the @-sign is not valid. It is not within a valid top-level domain."
            }
        }
    ]
}
