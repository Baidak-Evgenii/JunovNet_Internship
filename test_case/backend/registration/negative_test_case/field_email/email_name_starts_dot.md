...
### Сообщение об ошибке при отправке запроса с заполненым полем "email", имя емейла начинается с точки
    ...
    "detail": [
        {
            ...
            "msg": "value is not a valid email address: An email address cannot start with a period.",
            "input": ".test@9m.com",
            "ctx": {
                "reason": "An email address cannot start with a period."
            }
        }
    ]
}
