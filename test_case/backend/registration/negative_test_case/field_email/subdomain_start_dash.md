...
### Сообщение об ошибке при отправке запроса полем "email", тире в начале поддомена
    ...
    "detail": [
        {
            ...
            "msg": "value is not a valid email address: An email address cannot have a hyphen immediately after the @-sign.",
            "input": "test@-9m.com",
            "ctx": {
                "reason": "An email address cannot have a hyphen immediately after the @-sign."
            }
        }
    ]
}
