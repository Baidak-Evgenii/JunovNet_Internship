...
### Сообщение об ошибке при отправке запроса с заполненым полем "email", имя емейла заканчивается точкой
    ...
    "detail": [
        {
            ...
            "msg": "value is not a valid email address: An email address cannot have a period immediately before the @-sign.",
            "input": "jfnhfgkmjl.@lf.hf",
            "ctx": {
                "reason": "An email address cannot have a period immediately before the @-sign."
            }
        }
    ]
}
