...
### Сообщение об ошибке при отправке запроса с заполненым 51 символом полем "email"
...
```
{
  ...
  "email": "pigautpguiteeiteve-72317231@yopmailypmailyopail.com",
  "password": "123q56!A",
    ...
    "detail": [
        {
            ...
            "msg": "Value error, email must contain no more than 50 characters",
            "input": {
                "first_name": "Екатерина-OBAMA",
                "email": "pigautpguiteeiteve-72317231@yopmailypmailyopail.com",
                "password": "123q56!A",
