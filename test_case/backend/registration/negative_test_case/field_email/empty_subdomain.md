...
### Сообщение об ошибке при отправке запроса с заполненым полем "email", емейл без поддоменного имени
    ...
    "detail": [
        {
            ...
            "input": "test@.com",
            "ctx": {
                "reason": "An email address cannot have a period immediately after the @-sign."
            }
        }
    ]
}
